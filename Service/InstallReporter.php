<?php
/**
 * Standalone install + heartbeat reporter for Panth_AdvancedContactUs.
 *
...
namespace Panth\AdvancedContactUs\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_AdvancedContactUs';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-advanced-contact-us';
